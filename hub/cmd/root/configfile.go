...
func SetTestConfig() {
	...
	configSocket.GetEdgeDevice = "/api/v1/device/edge/getEdgeDevice"
	configSocket.GetEdgeDeviceToken = "a4b57c3a2241e9cfcf66e415e853d3b2"
	configSocket.EdgeInfoServerToken = "a4b57c3a2241e9cfcf66e415e853d3b2"
	configSocket.GetActivate = "/api/v1/edge/getActivate"
	configSocket.PutUpdateCMD = "/api/v1/device/updateCmd"
...
func SetDevConfig() {
	configSocket := &config.Info{}
	configSocket.EdgeInfoServer = "http://192.168.32.11:8083"
	configSocket.Socket = "43211"
	configSocket.PostEdge = "/api/v1/edge/data/create"
	configSocket.PutStatus = "/api/v1/edge/update/property"
	configSocket.GetInfo = "/api/v1/edge/getInfo"
	...
	configSocket.PostDevice = "/api/v1/iot/data/transfer"
	configSocket.DeviceInfoServer = "http://192.168.32.11:9000"
	configSocket.DeviceControlServer = "ws://192.168.32.11:8083/api/v1/ws/easyfetch"
	configSocket.GetEdgeDevice = "/api/v1/device/edge/getEdgeDevice"
	configSocket.GetEdgeDeviceToken = "a4b57c3a2241e9cfcf66e415e853d3b2"
...
func getENV() string {
	easyfetchHub := os.Getenv("easyfetchHub")
	if easyfetchHub == "" {
		easyfetchHub = "dev"
	}
	return easyfetchHub
